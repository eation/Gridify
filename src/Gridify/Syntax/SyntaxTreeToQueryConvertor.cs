...
internal static class ExpressionToQueryConvertor
{
      ...
      SyntaxNode op)
   {
      ...
      {
         var targetExp = selectExp.Arguments.Single(a => a.NodeType == System.Linq.Expressions.ExpressionType.Lambda) as LambdaExpression;
      ...
      Func<string, object>? convertor)
   {
      ...
      if (body.NodeType == System.Linq.Expressions.ExpressionType.Convert) body = ((UnaryExpression)body).Operand;
